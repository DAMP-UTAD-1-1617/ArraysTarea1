...
public class Acarreos{
    ...
    {
        int totalAcarreos=0; //Contador de los acarreos totales
        int acarreoActual=0; //variable de acarreo actual
        ...
        while (!terminado)
        {
            ...
            int suma=acarreoActual+i1+i2; //sumamos ambos mas el posible acarreo anterior
            acarreoActual=suma>=10?1:0; //Hay acarreo si la suma es es > 10
            totalAcarreos+=acarreoActual;
            ...
            terminado=!(acarreoActual>0) && (i>=s1.length() || i>s2.length());
        }
        return totalAcarreos;
    }
